...
namespace Arabica
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string trame = Serveur.RecevoirDuServeur();
            ...
            while (!fini)
            {
                ...
                Serveur.Jouer(1, var);
                valide = Serveur.GetValide();
                //if (!valide) throw new Exception();

                Console.WriteLine(Serveur.GetJeu());

                Console.WriteLine(Serveur.GetRejouer());
            }
